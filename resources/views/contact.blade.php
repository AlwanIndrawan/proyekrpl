    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top py-lg-0 px-lg-5 wow fadeIn" data-wow-delay="0.1s">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <a href="/ourwork" class="nav-item nav-link">Our Work</a>
                    ...
                    <div class="d-flex flex-column justify-content-between h-100">
                        <div class="bg-light d-flex align-items-center w-100 p-4 mb-4">
                            ...
                            <div class="ms-4">
                                ...
                                <h3 class="mb-0">Studio: Jl. Goa Ria No. 15</h3>
                            </div>
                        </div>
                        <div class="bg-light d-flex align-items-center w-100 p-4 mb-4">
                            <div class="d-flex flex-shrink-0 align-items-center justify-content-center bg-dark" style="width: 55px; height: 55px;">
                            ...
                            <div class="ms-4">
                                ...
                                <h3 class="mb-0">+6285827602240</h3>
                            </div>
                        </div>
                        <div class="bg-light d-flex align-items-center w-100 p-4">
                            ...
                            <div class="ms-4">
                                ...
                                <h3 class="mb-0">andiarianii@gmail.com</h3>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="container-xxl pt-5 px-0 wow fadeIn" data-wow-delay="0.1s">
                        <iframe class="w-100 mb-n2" style="height: 450px;"
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1049.541388361151!2d119.53091382551072!3d-5.095606210992253!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2dbefb98cd3aade5%3A0x8abe7632338104cb!2sJl.%20Goa%20Ria%20No.15%2C%20Sudiang%20Raya%2C%20Kec.%20Biringkanaya%2C%20Kota%20Makassar%2C%20Sulawesi%20Selatan%2090552!5e0!3m2!1sid!2sid!4v1713933658356!5m2!1sid!2sid"
